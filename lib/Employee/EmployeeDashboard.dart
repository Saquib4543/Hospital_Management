...
class _NewMedicalRequestPageState extends State<NewMedicalRequestPage> {
  ...
  // We'll store the entire item map for each piece of equipment
  List<Map<String, dynamic>> equipmentList = [];
  List<Map<String, dynamic>> displayedList = [];
  List<Map<String, dynamic>> filteredList = [];

  // Keep track of multiple selected items if you allow multiple selection
  ...
  /// Load all equipment from DropDownOption.equipmentData, then pick up to 10 random items
  /// for the "Recently Added Equipment" section.
  void _loadEquipment() {
  ...
  /// Picks up to [count] random items from the list.
  List<Map<String, dynamic>> _getRandomItems(List<Map<String, dynamic>> list, int count) {
    if (list.length <= count) return List.from(list);
    list.shuffle(Random());
    return list.sublist(0, count);
  }

  /// Filter the equipment list by name
  ...
  /// Show details in a pop-up dialog (like in TakeEquipmentPage)
  ...
  /// Submit the request after user fills out all fields
  void _submitRequest() {
    if (_formKey.currentState!.validate()) {
      // For demonstration, just pop. Or do your real submission logic here.
      ...
      body: Container(
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              children: [
                /// 1) Equipment Selection Section (Search bar + Recently Added list)
                Card(
                  elevation: 3,
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(12),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        /// Recently added equipment list (with checkboxes)
                        Container(
                              ...
                              return ListTile(
                                ...
                                trailing: Checkbox(
                                  ...
                                  onChanged: isUnavailable
                                    ...
                                    _toggleItemSelection(item, newValue);
                                  },
                                ),
                              );
                            },
                        ...
                        /// Just showing how many selected
                        Text(
                          selectedCount > 0
