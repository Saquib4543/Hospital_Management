...
class _EquipmentDisplayState extends State<EquipmentDisplay> {
  ...
  /// Called when the user submits the "Take Equipment" form.
  ...
  //   }
  //   // For demo, show a dialog with the data.
  //   showDialog(
  //     context: context,
  //     builder: (_) => AlertDialog(
  //       title: const Text("Equipment Take Request"),
  //       content: Text(
  ...
  /// Called when the user submits the "Submit Equipment" form.
  ...
  //     context: context,
  //     builder: (_) => AlertDialog(
  //       title: const Text("Equipment Return"),
  //       content: Text(
  ...
  //       child: Column(
  //         children: [
  //           // Scanned Items List with selection
  //           Row(
  ...
  //
  //           // Radio buttons for equipment action using ChoiceChips
  //           Row(
  ...
  //
  //           // Display the appropriate card based on the selected action.
